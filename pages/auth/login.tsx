    ...
    return (
        <main>
            <div className="grid justify-center">
                <div className="grid justify-center">
                    <Image className="drop-shadow-xl grid justify-center mt-10" src="/purple_logo.png" alt="WineWhisperer" width="130" height="130">
                    </Image>
                </div>
                <h1 className="drop-shadow-xl text-xl mt-5 text-brendan font-medium tracking-widest2 grid justify-center">
                    LOG IN
                </h1>
