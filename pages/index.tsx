  ...
  return (
    <main>
      ...
      <div className='grid mt-10 justify-center'>
        ...
        <Link href='/main/home'>
          <button type="submit" className="tracking-wide grid justify-center mt-8 text-center inline-flex items-center drop-shadow-xl text-xl text-black bg-[#C5B79E] hover:bg-lightdijon focus:ring-4 focus:outline-none focus:ring-[#F8DE7F]/50 font-medium rounded-lg px-5 py-3.5  text-center inline-flex items-center dark:focus:ring-[#3b5998]/55 mr-2 mb-2">
            Continue as Guest
          </button>
        </Link>
      </div>
