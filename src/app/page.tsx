  ...
  return (
    <main style={{ overscrollBehavior: "none" }} >
      <div className="grid justify-center">
        ...
        <a href='/authentication/login' className='justify-center text-center inline-flex items-center drop-shadow-xl text-xl  mt-12 text-black bg-dijon hover:bg-[#F8DE7F] focus:ring-4 focus:outline-none focus:ring-[#F8DE7F]/50 font-medium rounded-lg px-5 py-3.5  text-center inline-flex items-center dark:focus:ring-[#3b5998]/55 mr-2 mb-2'>
          <button type="button" className="tracking-widest2">
            LOG IN
          </button>
        </a>
        <a href='/authentication/signup' className='justify-center text-center inline-flex items-center drop-shadow-xl text-xl mt-3 text-black bg-dijon hover:bg-[#F8DE7F] focus:ring-4 focus:outline-none focus:ring-[#F8DE7F]/50 font-medium rounded-lg px-5 py-3.5  text-center inline-flex items-center dark:focus:ring-[#3b5998]/55 mr-2 mb-2'>
          <button type="button" className="tracking-widest2">
            SIGN UP
          </button>
        </a>
