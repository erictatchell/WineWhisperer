        ...
        <main >
            <div className="grid justify-center">
                ...
                <form action="../main/home" className="mt-5 grid">
                    <div className="mb-4">
                        <input type="name" id="name" className="bg-white border border-gray-300 text-black text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-white dark:border-gray-600 dark:placeholder-gray-500 dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Name" required></input>
                    </div>
                    <div className="mb-4">
            ...
            <div className='grid justify-center mb-3'>
                <a href='/authentication/login' className='justify-center text-center inline-flex items-center drop-shadow-xl text-md text-black bg-lightdijon hover:bg-dijon focus:ring-4 focus:outline-none focus:ring-[#F8DE7F]/50 font-medium rounded-lg px-5 py-1  text-center inline-flex items-center dark:focus:ring-[#3b5998]/55 mr-2 mb-2'>
